...
public class TC_RF_004 {
	...
	@Test
	public  void verifyRegistringAccountWithoutFillFields() throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[text()='My Account']")).click(); // My Account
		Thread.sleep(2000);
		
		driver.findElement(By.linkText("Register")).click(); // Register
		Thread.sleep(2000);
